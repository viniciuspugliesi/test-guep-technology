...
<html>
<head>
    <title>Cadastrar de usuários - Teste Guep</title>
...
<body>
    ...
    <div class="container">
        <h3 class="title mg-20--bottom">Cadastrar <span class="font-16">usuários</span></h3>

        <?php include(__DIR__ . '/../includes/messages.php') ?>
        
        <form action="/usuarios/cadastrar" method="post" name="users" class="form col-md-6">
            <div class="form-group">
                <label for="first_name">Nome do usuário: *</label>
                <input type="text" name="first_name" class="form-control" id="first_name" placeholder="Nome do usuário">
                <p class="message-js hide" data-message="first_name"></p>
            </div>
            
            <div class="form-group">
                <label for="last_name">Sobrenome do usuário: *</label>
                <input type="text" name="last_name" class="form-control" id="last_name" placeholder="Sobrenome do usuário">
